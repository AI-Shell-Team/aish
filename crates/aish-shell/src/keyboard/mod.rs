...
pub use bindings::{default_bindings, KeyCombination, KeyBindings};
...
mod tests {
    ...
    fn test_module_exports() {
        ...
        let _bindings = KeyBindings::new();
        let _combo = KeyCombination::simple(crossterm::event::KeyCode::Enter);

        // These are just type checks; actual usage would require a terminal
        let _: KeyBindings = default_bindings();
    }
}
