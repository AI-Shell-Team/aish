...
pub fn get_predefined_models(provider_id: &str) -> Vec<ModelInfo> {
    match provider_id {
        "ollama" => vec![
            ModelInfo { id: "llama3.2".into(), owned_by: Some("ollama".into()) },
            ModelInfo { id: "llama3.1".into(), owned_by: Some("ollama".into()) },
            ModelInfo { id: "qwen2.5".into(), owned_by: Some("ollama".into()) },
            ModelInfo { id: "deepseek-r1".into(), owned_by: Some("ollama".into()) },
            ModelInfo { id: "mistral".into(), owned_by: Some("ollama".into()) },
            ModelInfo { id: "codellama".into(), owned_by: Some("ollama".into()) },
            ModelInfo { id: "gemma2".into(), owned_by: Some("ollama".into()) },
            ModelInfo { id: "phi3".into(), owned_by: Some("ollama".into()) },
        ],
        "zhipu" | "zai" => vec![
            ModelInfo { id: "glm-4-plus".into(), owned_by: Some("zhipu".into()) },
            ModelInfo { id: "glm-4-0520".into(), owned_by: Some("zhipu".into()) },
            ModelInfo { id: "glm-4-flash".into(), owned_by: Some("zhipu".into()) },
            ModelInfo { id: "glm-4".into(), owned_by: Some("zhipu".into()) },
        ],
        "xai" => vec![
            ModelInfo { id: "grok-4".into(), owned_by: Some("xai".into()) },
            ModelInfo { id: "grok-3".into(), owned_by: Some("xai".into()) },
            ModelInfo { id: "grok-3-mini".into(), owned_by: Some("xai".into()) },
        ],
        "moonshot" => vec![
            ModelInfo { id: "kimi-k2.5".into(), owned_by: Some("moonshot".into()) },
            ModelInfo { id: "kimi-k2-turbo-preview".into(), owned_by: Some("moonshot".into()) },
            ModelInfo { id: "moonshot-v1-8k".into(), owned_by: Some("moonshot".into()) },
            ModelInfo { id: "moonshot-v1-32k".into(), owned_by: Some("moonshot".into()) },
            ModelInfo { id: "moonshot-v1-128k".into(), owned_by: Some("moonshot".into()) },
        ],
        "minimax" => vec![
            ModelInfo { id: "MiniMax-M2.5".into(), owned_by: Some("minimax".into()) },
            ModelInfo { id: "MiniMax-M2.5-highspeed".into(), owned_by: Some("minimax".into()) },
            ModelInfo { id: "MiniMax-M2.5-Lightning".into(), owned_by: Some("minimax".into()) },
        ],
        "qianfan" => vec![
            ModelInfo { id: "deepseek-v3.2".into(), owned_by: Some("baidu".into()) },
            ModelInfo { id: "ernie-4.0-8k".into(), owned_by: Some("baidu".into()) },
            ModelInfo { id: "ernie-4.0-turbo-8k".into(), owned_by: Some("baidu".into()) },
            ModelInfo { id: "ernie-3.5-8k".into(), owned_by: Some("baidu".into()) },
        ],
        "alibaba" => vec![
            ModelInfo { id: "qwen-max".into(), owned_by: Some("alibaba".into()) },
            ModelInfo { id: "qwen-plus".into(), owned_by: Some("alibaba".into()) },
            ModelInfo { id: "qwen-turbo".into(), owned_by: Some("alibaba".into()) },
            ModelInfo { id: "qwen-long".into(), owned_by: Some("alibaba".into()) },
            ModelInfo { id: "qwq-32b".into(), owned_by: Some("alibaba".into()) },
        ],
        "mistral" => vec![
            ModelInfo { id: "mistral-large-latest".into(), owned_by: Some("mistral".into()) },
            ModelInfo { id: "mistral-small-latest".into(), owned_by: Some("mistral".into()) },
            ModelInfo { id: "codestral-latest".into(), owned_by: Some("mistral".into()) },
            ModelInfo { id: "open-mistral-nemo".into(), owned_by: Some("mistral".into()) },
        ],
        _ => vec![],
    }
}
...
mod tests {
    ...
    fn test_filter_by_tool_support() {
        let models = vec![
            ModelInfo { id: "gpt-4".into(), owned_by: None },
            ModelInfo { id: "text-embedding-ada-002".into(), owned_by: None },
            ModelInfo { id: "claude-3-opus".into(), owned_by: None },
            ModelInfo { id: "dall-e-3".into(), owned_by: None },
            ModelInfo { id: "unknown-model".into(), owned_by: None },
        ];
