...
pub fn detect_provider_from_model(model: &str) -> ProviderInfo {
    ...
    let (id, display) = if model_lower.starts_with("claude")
...
fn dashboard_url_for(provider_id: &str) -> Option<String> {
    match provider_id {
        ...
        "minimax" => Some("https://platform.minimaxi.com/user-center/basic-information/interface-key".into()),
...
fn supports_tools_for(provider_id: &str) -> bool {
    match provider_id {
        "openai" | "anthropic" | "google" | "deepseek" | "mistral" | "ollama"
        | "xai" | "moonshot" | "minimax" | "openrouter" | "together"
        | "zhipu" | "zai" | "alibaba" | "qianfan" | "vllm" => true,
        _ => false,
    }
}
...
mod tests {
    ...
    fn test_qwen_detection() {
        ...
        let p3 = detect_provider("qwen-turbo", "https://dashscope.aliyuncs.com/compatible-mode/v1");
