...
impl<'a> ReActAgent<'a> {
    ...
    pub async fn run_with_system_prompt(
            ...
            match parsed {
                ...
                ParsedReact::Actions(actions) => {
                    ...
                    for action in &actions {
                        ...
                        let obs = match self.session.execute_tool_by_name(
                            &action.tool_name,
                            action.args.clone(),
                        ) {
                        ...
                        all_observations.push_str(&format!(
                            "Observation ({}): {}\n",
        ...
        Ok("Agent reached the maximum number of iterations without producing a final answer.".to_string())
    }
