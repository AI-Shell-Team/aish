...
- `/lib/systemd/system/aish-sandbox.service` - Systemd service (deb/apk)
- `/lib/systemd/system/aish-sandbox.socket` - Systemd socket (deb/apk)
- `/usr/lib/systemd/system/aish-sandbox.service` - Systemd service (rpm)
- `/usr/lib/systemd/system/aish-sandbox.socket` - Systemd socket (rpm)
