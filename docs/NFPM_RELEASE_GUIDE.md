...
| `debian/aish-sandbox.service` | `/lib/systemd/system/aish-sandbox.service` | systemd 服务 |
| `debian/aish-sandbox.socket` | `/lib/systemd/system/aish-sandbox.socket` | systemd socket |
